...
void printMenu(char row[5], unsigned int rownum); //Vykresli hlavni menu
void play(char Omatrix[9][9], char Gmatrix[9][9], int gamemode); //Samotny herni mechanismus, vola ostatni funkce, je volana z menu()