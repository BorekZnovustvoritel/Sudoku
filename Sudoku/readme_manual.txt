...
2)* Save the current game
    ...
    vyvarujte se však ukládání her pod názvy '000.txt', '001.txt', '002.txt'
    a 003.txt, jinak by došlo ke smazání pùvodních souborù. Po zadání názvu se
    vytvoøí v adresáøi soubor s Vámi vybranım jménem. Tento soubor obsahuje Vámi
...
1) Vytvoøte v adresáøi Playgrounds novı textovı soubor. Název souboru by nemìl
...
2) Zapisujte èísla vdy 9 na øádek. Pokud má bıt v hracím poli prázdné místo,
    ...
    nepouívejte.
3) Zavøete editor textového souboru a spuste program. Zvolte monost 'Load
    a saved game' a vlote název souboru. Nezapomeòte na pøíponu .txt.
